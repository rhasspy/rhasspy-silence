...
class WebRtcVadRecorder(VoiceCommandRecorder):
    ...
    async def record(self, audio_source: typing.BinaryIO) -> VoiceCommand:
        ...
        # State
        events: typing.List[VoiceCommandEvent] = []
        ...
        silence_buffers = int(math.ceil(self.silence_seconds / self.seconds_per_buffer))
